...
- <h5> <span id="double_add">double_add()</span></h5>
...
printd(res); // Output: 3
```
- <h5> <span id="double_div">double_div()</span></h5>
...
printd(a); // Output: 0.1
```
- <h5> <span id="double_eq">double_eq()</span></h5>
...
printi(res); // Output: 0
```
- <h5> <span id="double_gt">double_gt()</span></h5>
...
- <h5> <span id="double_lt">double_lt()</span></h5>
...
- <h5> <span id="double_mult">double_mult()</span></h5>
...
```
- <h5> <span id="double_to_i64">double_to_i64()</span></h5>
...
- <h5> <span id="i64_to_double">i64_to_double()</span></h5>
...
printd(res); // Output: 3
```
 - <h5> <span id="multeq_i128">multeq_i128()</span></h5>
